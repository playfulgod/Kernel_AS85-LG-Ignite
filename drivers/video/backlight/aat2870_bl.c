...
//20110705 yongman.kwon@lge.com [LS855] change max current for saving battery .
//31 -> 26
...
//20110224 bryan.lee@lge.com - 
//	val = (unsigned char) (level * 23 / 255);//min:30 max 255
//	val = (unsigned char) (level * 31 / 255);//min:30 max 255
 //20110705 yongman.kwon@lge.com [LS855] change max current for saving battery .
	val = (unsigned char) (level * 26 / 255);//min:30 max 255

	//printk("%s: *********** level %d, val %d\n", __func__, level, val);
