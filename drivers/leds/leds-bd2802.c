...
#define BD2802_CURRENT_WHITE_MAX 	0x14 /* 4mA */ 	//0x32 /* 10mA */
#define BD2802_CURRENT_BLUE_MAX		0x14 /* 4mA */	//0x32 /* 10mA */
#define BD2802_CURRENT_WHITE_MIN	0x01 /* 0.2mA */	//0x05 /* 1mA */
#define BD2802_CURRENT_BLUE_MIN		0x01 /* 0.2mA */	// 0x05 /* 1mA */
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	else if ((value==0)&&(led->led_state!=BD2802_OFF))
	{
		bd2802_off(led);
#if defined (CONFIG_LGE_LAB3_BOARD)
//		gpio_set_value(KEY_LED_RESET, 0);//2011.08.22 hyunkyung.shin@lge.com
#else
...
static struct device_attribute bd2802_reg##reg_addr##_attr = {		\
	.attr = {.name = reg_name, .mode = 0664, .owner = THIS_MODULE},	\
