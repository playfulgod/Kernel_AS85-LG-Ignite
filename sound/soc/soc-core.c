...
extern int voice_get_curmode(void); // SPK Call Mute, lab3
...
static int incallnosuspend = 0; // SPK Call Mute, lab3
...
static DEVICE_ATTR(codec_reg, 0774, codec_reg_show, codec_reg_store);
#else
